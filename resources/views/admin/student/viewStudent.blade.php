                                            ...
                                            <div class="row justify-content-md-center">
                                                <div class="input-field col m6 s12">
                                                    <div>
                                                        ...
                                                        @if(Storage::disk('school')->exists($category->logo))
                                                        <img class="preview" src="{{Storage::disk('school')->url($category->logo)}}" alt="" width="150px">
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="input-field col m6 s12">
                                                    <div>
                                                        ...
                                                        @if(Storage::disk('school')->exists($category->icon))
                                                        <img class="preview" src="{{Storage::disk('school')->url($category->icon)}}" alt="" width="150px">
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="input-field col m6 s12">
                                            ...
                                            <ul class="collapsible popout" id="categoryLocaleCollapsible">
                                                ...
                                                <li @if($loop->first) class="active" @endif>
                                                    <div class="collapsible-header">
                                                        @if(Storage::disk('school')->exists($language->flag))
                                                        <img class="preview" src="{{Storage::disk('school')->url($language->flag)}}" alt="" width="20px">
                                                        @endif
