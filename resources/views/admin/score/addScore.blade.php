...
@push('style')
<link rel="stylesheet" href="{{asset('css/admin/score/addScore.css')}}">
@endpush

@push('script')
<script src="{{asset('js/admin/score/addScore.js')}}"></script>
@endpush
                ...
                <div class="section">
                    <div class="card">
                        <div class="card-content">
                            <div class="row">
                                <div class="col s12">
                                    <form action="{{route('score_save')}}" id="scoreForm" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row justify-content-md-center">
                                            ...
                                            <div class="input-field col m6 s12">
                                                <input type="number" value="{{old('maths')}}" name="maths" id="maths">
                                        ...
                                        <div class="row justify-content-md-center">
                                            <div class="input-field col m6 s12">
                                                <input type="number" value="{{old('sceince')}}" name="sceince" id="sceince">
                                            ...
                                            <div class="input-field col m6 s12">
                                                <input type="number" value="{{old('history')}}" name="history" id="history">
                                        ...
                                        <div class="row justify-content-md-center">
                                            <div class="input-field col m6 s12">
                                                <input type="text" value="{{old('term')}}" name="term" id="term">
