            ...
            <div class="section">
                <div class="card">
                    <div class="card-content">
                        <div class="row">
                            <form id="roleFilterAttribute" class="searchform" class="searchform">
                                <div class="col s12 m6 l3">
                                    <label for="users-list-status">Status</label>
                                    <div class="input-field">
                                        <select class="select2" id="role-status">
                                ...
                                <div class="show-btn" style="height: 50px;">
                                    ...
                                    @can('role_create')
                                    <a class="btn waves-effect waves-light breadcrumbs-btn" href="{{route('role_add')}}">
                    ...
                    <div class="card-content">
                        <div class="row">
                            <div class="col s12 data-list-table">
                                <table class="users-list-datatable" id="roles-list-datatable" class="table" data-url="{{route('role_table')}}">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Title</th>
